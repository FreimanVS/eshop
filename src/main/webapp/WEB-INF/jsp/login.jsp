				...
				<%--<div class="row">--%>
					<%--<div class="col-sm-4">--%>
						<%--<div class="logo pull-left">--%>
							<%--<a href="${pageContext.request.contextPath}/eshop/index.html"><img src="images/home/logo.png" alt="" /></a>--%>
						<%--</div>--%>
					...
					<%--<div class="col-sm-8">--%>
						<%--<div class="shop-menu pull-right">--%>
							<%--<ul class="nav navbar-nav">--%>
								...
								<%--<li><a href="${pageContext.request.contextPath}/eshop/login.html" class="active"><i class="fa fa-lock"></i> Login</a></li>--%>
							<%--</ul>--%>
						<%--</div>--%>
					<%--</div>--%>
				<%--</div>--%>
							...
							<%--<ul class="nav navbar-nav collapse navbar-collapse">--%>
								...
								<%--<li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>--%>
                                    <%--<ul role="menu" class="sub-menu">--%>
										...
										<%--<li><a href="${pageContext.request.contextPath}/eshop/login.html" class="active">Login</a></li>--%>
                                    <%--</ul>--%>
                                <%--</li> --%>
