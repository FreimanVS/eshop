...
<head>
    ...
    <link id="valHolder" data-val="${param.val}"/>
    <script src="//ajax.googleapis.com/ajax/libs/jquery/1.8.1/jquery.min.js" type="text/javascript"></script>
    <script src="${pageContext.request.contextPath}/js/searchresult.js" type="text/javascript"></script>
...
<header id="header"><!--header-->
    ...
    <%--&lt;%&ndash;<li><a href="${pageContext.request.contextPath}/WEB-INF/jsp/login.jsp"><i class="fa fa-lock"></i> Login</a></li>&ndash;%&gt;--%>
    <%--<c:choose>--%>
    ...
    <%--<li><a href="${pageContext.request.contextPath}/eshop/index.html">Home</a></li>--%>
    ...
    <%--<li><a href="${pageContext.request.contextPath}/eshop/cart.jsp">Cart</a></li>--%>
...
<section id="advertisement">
    ...
    <%--<div class="container">--%>
    <%--<img src="${pageContext.request.contextPath}/eshop/images/shop/advertisement.jpg" alt="" />--%>
    <%--</div>--%>
</section>
                ...
                <div class="left-sidebar">
                    ...
                    <div class="price-range"><!--price-range-->
                        ...
                        <div class="well">
                            ...
                            <button onclick="filter()">accept</button>
                            <%--</form>--%>
                        </div>
                    </div><!--/price-range-->
