...
<head>
    ...
    <link id="searchJson" data-searchJson="${requestScope.searchJson}"/>
                            ...
                            <c:forEach var="goods" items="${goods}">
                                <tr>
                                    <td class="cart_product">
                                        <a href=""><img src="${pageContext.request.contextPath}/eshop/images/shop/<c:out value="${goods.img}"/>"  alt=""></a>
                                    </td>
                                    <td class="cart_description">
                                        <h4><a href=""><c:out value="${goods.name}"/></a></h4>
                                        <p>Web ID: <c:out value="${goods.id}"/></p>
                                    </td>
                                    <td class="cart_price">
